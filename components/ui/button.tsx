  ...
  "inline-flex hover:cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        "brand-blue":
          "bg-brand-blue text-brand-blue-foreground shadow-xs hover:bg-brand-blue/90",
        "brand-purple":
          "bg-brand-purple text-brand-purple-foreground shadow-xs hover:bg-brand-purple/90",
        "brand-teal":
          "bg-brand-teal text-brand-teal-foreground shadow-xs hover:bg-brand-teal/90",
        "brand-orange":
          "bg-brand-orange text-brand-orange-foreground shadow-xs hover:bg-brand-orange/90",
        "brand-pink":
          "bg-brand-pink text-brand-pink-foreground shadow-xs hover:bg-brand-pink/90",
      },
      size: {
